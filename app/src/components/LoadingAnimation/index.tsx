...
export default function LoadingAnimation(): React.ReactNode {
  const animationStyles: React.CSSProperties = {
    objectFit: "scale-down",
  };
  return (
    <div className="components-LoadingAnimation">
      <img style={animationStyles} src={LOADING_GIF_DATA} alt="Loading Animation" onLoad={void 0} />
    </div>
  );
}
