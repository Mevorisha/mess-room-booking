...
const API_SERVER_URL = IS_DEV ? (import.meta.env["VITE_API_SERVER_URL"] as Nullable<string> ?? "") : (prodApiServerUrl as string);
const FIREBASE_APPCHECK_DEBUG_TOKEN = import.meta.env["VITE_FIREBASE_APPCHECK_DEBUG_TOKEN"] as Nullable<string> ?? "";
